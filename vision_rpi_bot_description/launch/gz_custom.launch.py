...
# ================== ENVIRONMENT SETUP =================== #
    ...
    robot_description_path = get_package_share_directory('vision_rpi_bot_description')  # -----> Change me!
    robot_package = FindPackageShare('vision_rpi_bot_description') # -----> Change me!
    robot_name = 'vision_rpi_bot' # Verify this matches your robot's actual spawned name/tf_prefix
    robot_urdf_file_name = 'robot.urdf.xacro'
    rviz_config_file_name = 'config_with-Lidar-and-Camera.rviz'
    custom_world_file_name = 'world1.sdf'
